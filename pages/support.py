...
success_metrics = ['Average playtime forever', 'Peak CCU', 'Reviews', 'Recommendations', 'Review score']
...
descriptions = {
    "Individual OS": "Each individual operating system (Windows, Mac, Linux) is displayed separately, regardless of whether the game supports multiple systems.",
...
for data_type, column in data_types.items():
    with st.expander(f"{data_type} Visualizations"):
        ...
        st.write(f"""
            This section provides an analysis of the selected success metrics across {data_type}.
            You can compare different combinations of OS support and see how they affect the chosen metrics.
        """)
        ...
        with plots.pop(1):
            ...
            if data_type == 'Individual OS':  # Bar plot instead of pie
                ...
                # Pie chart without category orders (unordered)
