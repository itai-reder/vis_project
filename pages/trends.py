...
import json
from sidebar import apply_filters_sidebar, notes_sidebar

# Define fields, including the new "Games Released" feature
fields = ['Recommendations', "Peak CCU", 'Average playtime forever','Reviews', 'Games Released', 'Review score']
...
Use the filters below to customize the comparisons.
""")
...
# Load the release and genres dictionaries
@st.cache_data
...
# df = apply_filters_sidebar(df)  # Apply filters
